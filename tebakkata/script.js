...
(function($, window, undefined){
  ...
  Hangman = {
    ...
    randomWord: function(){
      var b = this._wordData(this.words[ Math.floor(Math.random() * this.words.length)] );

      let obj = arr.find(o => o.key === b.word);

      this.msgQuestion.html(obj.value);
      return b;
    },
    ...
    win: function(){
      ...
      this.msgTitle.html("Yeayyy, Kamu Berhasil!");
      // this is messy
      this.msgText.html("Kamu menyelesaikan dengan <span class='highlight'>" + rating.guesses + "</span> kata tebakan!<br>Score: <span class='highlight'>" + rating.rating + "%</span>");
      this.showMsg();
    ...
    lose: function(){
      this.msgTitle.html("Yahh kamu belum beruntung ayo coba lagi dan jangan menyerah ya.. Jawaban yang tepat adalah <span class='highlight'>"+ this.wrd.word +"</span>");
      this.msgText.html("Jangan khawatir kegagalan awal dari kesuksesan!");
      this.showMsg();
  ...
  var wordList = ["banyak", "riko", "mata", "sehat dan kuat", "disayangi", "berpamitan"];

  let arr = [
    { key:"banyak", value:"rani punya 8 boneka ayuk punya 12 boneka berarti boneka ayuk lebih ……….. dari boneka ita"},
    { key:"riko", value:"deni punya 10 permen ahmad punya 9 permen riko punya 11 permen siapa yang permennya paling banyak ?"},
    { key:"mata", value:"kita dapat melihat benda di sekitar kita menggunakan …"},
    { key:"sehat", value:"tubuh manusia butuh makanan dan minuman agar tetap …"},
    { key:"disayangi", value:"jika kita menjadi juara kelas maka kita bisa … guru."},
    { key:"berpamitan", value:"saat akan berangkat sekolah kita harus …"}
  ];
